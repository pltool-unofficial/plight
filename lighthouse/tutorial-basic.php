...
<main class="container">
    <div class="home-section-head">
        <div>
            <h1 class="page-title" style="margin:0 0 4px;">基础教程</h1>
            <p class="post-meta">物理实验基础教程与入门指引。</p>
        </div>
    ...
    <div class="home-section">
        ...
        <?php else: ?>
            ...
            <?= buildPagination($page, $totalPages, '/lighthouse/tutorial-basic.php') ?>
        <?php endif; ?>
    </div>
</main>
