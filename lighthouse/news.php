...
<main class="container">
    <div class="home-section-head">
        <div>
            <h1 class="page-title" style="margin:0 0 4px;">最近新闻</h1>
            <p class="post-meta">近期动态与资讯汇总。</p>
        </div>
    ...
    <div class="home-section">
        ...
        <?php else: ?>
            ...
            <?= buildPagination($page, $totalPages, '/lighthouse/news.php') ?>
        <?php endif; ?>
    </div>
</main>
