...
<main class="container">
    <div class="home-section-head">
        <div>
            <h1 class="page-title" style="margin:0 0 4px;">论文共赏</h1>
            <p class="post-meta">经典与前沿论文共赏。</p>
        </div>
    ...
    <div class="home-section">
        ...
        <?php else: ?>
            ...
            <?= buildPagination($page, $totalPages, '/wenxuan/papers.php') ?>
        <?php endif; ?>
    </div>
</main>
